...
* [Inglés](README.md) - versión original
* [Portugués](pt/README.md) - versión 2.0.1
...
| Rol                   | Nombre                                             |
| --------------------- | -------------------------------------------------- |
| ***Contribuyentes:*** | <ul><li>[gg2001](https://github.com/gg2001) (Go, Node.js sections)</li><li>[gorazdko](https://github.com/gorazdko) (Rust section)</li><li>[Javier Vargas](https://github.com/javiervargas) (C, Java, Lightning, Tor sections)</li><li>[jodobear](https://github.com/jodobear) (Appendix: Compiling Bitcoin, Python section)</li><li>[Prayank](https://github.com/prayank23) (i2p sections)    </li></ul> |
